...
public class dateCreate {
    ...
    public void execute(String dateId, String userId, String barberoid, String typeService, String serviceId, String dateDate, String addID){
        Date date = new Date(new DateId(dateId), new UserId(userId), new UserId(barberoid), new TypeServiceId(typeService), new ServiceId(serviceId), new DateDate(dateDate), new AddressId(addID));
